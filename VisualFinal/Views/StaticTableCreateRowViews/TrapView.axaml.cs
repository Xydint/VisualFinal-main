...
{
    public partial class TrapView : Window
    {
        public TrapView()
        {
            InitializeComponent();
        ...
        public TrapView(MainWindowViewModel? mainContext) : this()
        {
            this.DataContext = new TrapViewModel(mainContext);
        }
        ...
        {
            var dc = (this.DataContext as TrapViewModel);
            dc.MainContext.Data.Traps.Add(dc.Trap);
